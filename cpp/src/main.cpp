...
int main(int argc, char **argv) {
    ...
    std::cout << "  det: " << modelDetPath << std::endl;
    std::cout << "  cls: " << modelClsPath << std::endl;
    std::cout << "  rec: " << modelRecPath << std::endl;
    std::cout << "  keys: " << keysPath << std::endl;
