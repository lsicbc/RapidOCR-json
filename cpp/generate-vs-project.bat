...
else if %flag% == 1 (call :gen2026-x86)^
else if %flag% == 2 (call :gen2026-x64)^
else (echo "输入错误！Input Error!")
GOTO:EOF
...
:gen2026-x86
mkdir build-win-vs2026-x86
pushd build-win-vs2026-x86
call :cmakeParams "Visual Studio 18 2026" "Win32"
popd
GOTO:EOF

:gen2026-x64
mkdir build-win-vs2026-x64
pushd build-win-vs2026-x64
call :cmakeParams "Visual Studio 18 2026" "x64"
popd
GOTO:EOF
